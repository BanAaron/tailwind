...
<main class="grid grid-cols-1 text-slate-50 md:grid-cols-2 xl:grid-cols-3">
  ...
  <Section name="about" backgroundDark={false}>
    ...
    <p>
      After many years (and too many games of StarCraft 2) I decided to study <a class="text-slate-300 hover:text-teal-300"
                                                                                 href="https://www.northampton.ac.uk/courses/games-programming-bsc-hons/" target="_blank">Computer
    ...
    <p>
      It turns out that making video games isn't quite as fun as playing them! Instead I discovered my passion was in <a class="text-slate-300 hover:text-teal-300"
                                                                                                                         href="#Welcome Break">databases</a> and <a
      class="text-slate-300 hover:text-teal-300" href="#Dentsu">web development</a>.
    </p>
    <br>
    <p>
  ...
  <Section name="work">
    <div class="grid grid-cols-1 gap-7" id="jobs">
      ...
      <!-- Welcome Break -->
      <Job companyName="Welcome Break"
           jobTitle="Database Admin"
           location="Milton Keynes"
           start="2019"
           end="2020"
           url="https://www.welcomebreak.co.uk/"
      >
        <p>
      ...
      <!-- Invu -->
      <Job companyName="Invu"
           jobTitle="Professional Services"
           location="Northampton"
           start="2018"
           end="2019"
           url="https://www.agilico.co.uk/invu/"
      >
        <p>
  ...
  <Section name="projects">
    <div class="grid grid-cols-1 gap-7" id="projects">
      <!-- aaronbarratt.dev -->
      <Project projectName="aaronbarratt.dev" tags={["Svelte", "JavaScript", "Tailwind", "HTML", "Design"]} url="https://github.com/BanAaron/aaronbarratt-v2">
        <p>
          ...
          and <a class="text-slate-300 hover:text-teal-300" href="https://tailwindcss.com/" target="_blank">Tailwind</a>.
        </p>
        <p>
          Using active design principles to work flawlessly for mobile and desktop.<br>
        </p>
      </Project>
      <!-- resolution changer -->
      <Project projectName="Resolution Changer" tags={["Python", "Pystray", "Windows API"]} url="https://github.com/BanAaron/resolution-changer">
        <p>
      ...
      <!-- image cropper -->
      <Project projectName="Image Cropper" tags={["Python", "Pillow", "Tkinter"]} url="https://github.com/BanAaron/resolution-changer">
        <p>
          A simple GUI application to bulk crop images. Made using the <a class="text-slate-300 hover:text-teal-300" href="https://pypi.org/project/Pillow/" target="_blank">Pillow</a> image
          processing library.
        </p>
      </Project>
      <!-- tekken -->
      <Project projectName="Tekken 8 API" tags={["Go", "API", "PostgreSQL", "Supase"]} url="https://github.com/BanAaron/tekken-backend">
        <p>
          ...
          8</a>. This is a work in progress.
        </p>
        <p>
